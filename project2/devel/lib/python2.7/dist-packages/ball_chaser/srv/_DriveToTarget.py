...
class DriveToTargetResponse(genpy.Message):
  _md5sum = "0a358b329841b60dd6018e081ae7a990"
  _type = "ball_chaser/DriveToTargetResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string msg_feddback

"""
  __slots__ = ['msg_feddback']
  _slot_types = ['string']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.msg_feddback = str[start:end].decode('utf-8')
      else:
        self.msg_feddback = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class DriveToTarget(object):
  ...
  _md5sum = '77f5e0b22e526999e565204948a41fa6'
