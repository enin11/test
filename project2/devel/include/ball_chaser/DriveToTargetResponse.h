...
struct DriveToTargetResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _msg_feddback_type;
  _msg_feddback_type msg_feddback;
...
struct MD5Sum< ::ball_chaser::DriveToTargetResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x0a358b329841b60dULL;
  static const uint64_t static_value2 = 0xd6018e081ae7a990ULL;
};
...
struct Printer< ::ball_chaser::DriveToTargetResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "msg_feddback: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.msg_feddback);
  }
};
