...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DriveToTarget-request>)))
  ...
  "77f5e0b22e526999e565204948a41fa6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DriveToTarget-request)))
  "Returns md5sum for a message object of type 'DriveToTarget-request"
  "77f5e0b22e526999e565204948a41fa6")
...
(cl:ensure-generic-function 'msg_feddback-val :lambda-list '(m))
(cl:defmethod msg_feddback-val ((m <DriveToTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_chaser-srv:msg_feddback-val is deprecated.  Use ball_chaser-srv:msg_feddback instead.")
  (msg_feddback m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DriveToTarget-response>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'msg_feddback))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'msg_feddback))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DriveToTarget-response>) istream)
  "Deserializes a message object of type '<DriveToTarget-response>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'msg_feddback) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'msg_feddback) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
